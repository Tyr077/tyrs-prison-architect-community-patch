...
tiles `StatusEffects.tazed = 60` every four game seconds.
...
- Patched game: prisoners near the object drop as if tazed and show the tazed
  icon, get up after a while, and are tazed again on the next pass.
